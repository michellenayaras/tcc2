...
class EstudoTecidoAnatomiaFisiologia extends StatefulWidget {
  const EstudoTecidoAnatomiaFisiologia({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _EstudoTecidoAnatomiaFisiologiaState createState() =>
      _EstudoTecidoAnatomiaFisiologiaState();
}

class _EstudoTecidoAnatomiaFisiologiaState
    extends State<EstudoTecidoAnatomiaFisiologia> {
  late Future<List<Map<String, dynamic>>> _data;

  @override
  void initState() {
    super.initState();
    _data = MyDatabase().getData('Anatomia e fisiologia da pele');
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Image.asset(
                          'assets/images/derme.jpg',
                          height: 250.0,
                          fit: BoxFit.cover,
                        ),
                      ),
                      ...sections.map((section) {
                        final titleEndIndex = section.indexOf(')') + 1;
                        final title = section
                            .substring(0, titleEndIndex)
                            .trim(); // remove caracteres de espaço em branco
