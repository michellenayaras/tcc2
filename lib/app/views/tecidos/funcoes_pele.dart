...
class EstudoTecidosFuncoesPele extends StatefulWidget {
  const EstudoTecidosFuncoesPele({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _EstudoTecidosFuncoesPeleState createState() =>
      _EstudoTecidosFuncoesPeleState();
}

class _EstudoTecidosFuncoesPeleState extends State<EstudoTecidosFuncoesPele> {
  late Future<List<Map<String, dynamic>>> _data;

  @override
  void initState() {
    super.initState();
    _data = MyDatabase().getData('Funções da pele');
  }
