...
class EstudoSecrecoesExsudatoSanguinolento extends StatefulWidget {
  const EstudoSecrecoesExsudatoSanguinolento({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _EstudoSecrecoesExsudatoSanguinolentoState createState() =>
      _EstudoSecrecoesExsudatoSanguinolentoState();
}

class _EstudoSecrecoesExsudatoSanguinolentoState
    extends State<EstudoSecrecoesExsudatoSanguinolento> {
  late Future<List<Map<String, dynamic>>> _data;

  @override
  void initState() {
    super.initState();
    _data = MyDatabase().getData('Exsudato sanguinolento');
  }
                            ...
                            child: ClipRRect(
                              ...
                              child: Ink.image(
                                image: const AssetImage(
                                    'assets/images/exsudato_sanguinolento.jpg'),
                                fit: BoxFit.cover,
                                height: 300.0,
                                child: InkWell(
                                  onTap: () {
