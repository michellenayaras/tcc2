...
class EstudoLesoesEtiologia extends StatefulWidget {
  const EstudoLesoesEtiologia({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _EstudoLesoesEtiologiaState createState() => _EstudoLesoesEtiologiaState();
}

class _EstudoLesoesEtiologiaState extends State<EstudoLesoesEtiologia> {
  ...
  void initState() {
    super.initState();
    _data = MyDatabase().getData('Etiologia');
  }
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Padding(
                                      padding: EdgeInsets.all(8.0),
                                      child: Text(
                                        "Quando ocorre de maneira imprevista, sendo provocada por objetos cortantes, contundentes, perfurantes, lacerantes, inoculação de venenos, mordeduras e queimaduras em geral.",
                                        style: TextStyle(
                                          fontSize: 18.0,
                                          fontFamily: 'Roboto',
                                        ),
                                    ...
                                    Padding(
                                      ...
                                      child: Image.asset(
                                        'assets/images/acidental_traumática.jpg',
                                        height: 200.0,
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Padding(
                                      padding: EdgeInsets.all(8.0),
                                      child: Text(
                                        "Quando é realizada de acordo com um fim terapêutico proposto.",
                                        style: TextStyle(
                                          fontSize: 18.0,
                                          fontFamily: 'Roboto',
                                        ),
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Image.asset(
                                        'assets/images/intencional_cirurgica.jpg',
                                        height: 220.0,
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Padding(
                                      padding: EdgeInsets.all(8.0),
                                      child: Text(
                                        "São lesões secundárias à uma determinada doença de base.",
                                        style: TextStyle(
                                          fontSize: 18.0,
                                          fontFamily: 'Roboto',
                                        ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Padding(
                                      padding: EdgeInsets.all(8.0),
                                      child: Text(
                                        "São feridas resultantes de procedimentos ou tratamentos. ",
                                        style: TextStyle(
                                          fontSize: 18.0,
                                          fontFamily: 'Roboto',
                                        ),
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Image.asset(
                                        'assets/images/iatrogênicas.jpg',
                                        height: 230.0,
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Padding(
                                      padding: EdgeInsets.all(8.0),
                                      child: Text(
                                        "São feridas resultantes de pressão contínua exercida pelo peso do corpo, fricção, cisalhamento e umidade, como a lesão por pressão.",
                                        style: TextStyle(
                                          fontSize: 18.0,
                                          fontFamily: 'Roboto',
                                        ),
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Image.asset(
                                        'assets/images/fatores_causais_externos.jpg',
                                        height: 230.0,
                                        fit: BoxFit.cover,
                                      ),
                                    ),
