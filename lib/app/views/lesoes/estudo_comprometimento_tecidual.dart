...
class EstudoLesoesComprometimentoTecidual extends StatefulWidget {
  const EstudoLesoesComprometimentoTecidual({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _EstudoLesoesComprometimentoTecidualState createState() =>
      _EstudoLesoesComprometimentoTecidualState();
}

class _EstudoLesoesComprometimentoTecidualState
    extends State<EstudoLesoesComprometimentoTecidual> {
  ...
  void initState() {
    super.initState();
    _data = MyDatabase().getData('Comprometimento tecidual');
  }
                              ...
                              children: [
                                Container(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 16.0),
                                  child: const Text(
                                    "Perda parcial de tecido envolvendo a epiderme ou derme, ulceração superficial com presença de bolhas ou cratera rasa.",
                                    style: TextStyle(
                                      fontSize: 18.0,
                                      fontFamily: 'Roboto',
                                    ),
